    ...
    public partial class PostsAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "My first post will be about performing CRUD operations in MVC.It is so much fun.", "My first post" });
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Content", "Title" },
                values: new object[] { 3, "Hello there! I am getting better and better in CRUD operations in MVC.", "My third post" });
        }
